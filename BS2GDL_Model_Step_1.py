...
class CustomModel(tf.keras.Model):
    ...
    def __init__(self, num_points=40, input_size=(256, 256, 1), bspline_points=20):
        super(CustomUNetModel, self).__init__()
        self.input_size = input_size
        self.num_points = num_points
        self.bspline_points = bspline_points
        # self.lcc_loss_layer = LCCLossLayer()
        # self.prediction_weights = tf.Variable(initial_value=tf.ones((8,)), trainable=True, name='prediction_weights')
        self.AttentionGate1 = AttentionGate(F_g=256, F_l=256,
                                            F_int=128)  # Tailles d'exemple, ajustez selon votre architecture
        ...
        # Architecture
        self.c1a = Conv2D(32, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same',
