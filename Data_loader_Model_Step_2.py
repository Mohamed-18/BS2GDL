...
def load_json_data(json_file):
    """
    Loads JSON file containing nodal points.

    Args:
    - json_file: Path to the JSON file.

    Returns:
    - Dictionary of nodal points.
    """
...
def load_data(image_folder, mask_epi_folder, cont_epi_folder, seg_folder, json_file, target_size=(256, 256)):
    ...
    - mask_epi_folder: Directory containing mask files.
    - cont_epi_folder: Directory containing contour files.
    - seg_folder: Directory containing segmentation masks.
    - json_file: Path to the JSON file with nodal points.
    - target_size: Tuple for resizing images.
    - max_points: Maximum number of nodal points.

    Returns:
    - Tuple of preprocessed images, masks, nodal points, contours, and segmentations.
    """
